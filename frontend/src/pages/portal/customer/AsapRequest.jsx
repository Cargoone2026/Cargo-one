...
import {
  ...
  KeyRound, Wrench, BatteryLow, Ban, HelpCircle, Disc,
  FileText, Heart, Layers, Armchair, Cog, Boxes, ShoppingBag,
} from "lucide-react";
...
function ConditionCardGrid({ selected, onSelect }) {
  return (
    <div
      className="grid grid-cols-2 gap-2"
      role="radiogroup"
        ...
        return (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="text-[12px] font-semibold leading-tight text-neutral-900">{opt.label}</div>
...
function YesNoChipRow({ name, value, onChange }) {
  return (
    <div
...
function CategoryChipGrid({ selected, onSelect }) {
  return (
    <div
      className="grid grid-cols-2 gap-2"
      role="radiogroup"
